...
export default function Home() {
  ...
  if (!mounted) return <main className="loading-screen"><div className="loading-mark">US</div><span>Đang chuẩn bị không gian tri thức…</span></main>;
  return <main className="client-shell"><div className="client-glow client-glow-one" /><div className="client-glow client-glow-two" /><Navbar /><div className="client-container">
    ...
    <footer className="client-footer"><div className="footer-brand"><span className="brand-badge">US</span><strong>UniSynapse</strong><span>Trí tuệ học thuật mở.</span></div><div className="footer-links"><button onClick={() => goToTab("overview")}>Trang chủ</button><button onClick={() => goToTab("learning")}>Học tập</button><button onClick={() => goToTab("tutor")}>AI Tutor</button><button onClick={() => goToTab("ledger")}>Proof</button></div><span className="footer-copy">© 2026 · Solana Devnet</span></footer>
