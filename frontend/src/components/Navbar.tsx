        ...
        <div className="w-full max-w-[1780px] 2xl:max-w-[1920px] mx-auto flex justify-between items-center gap-2 sm:gap-4">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2.5">
            ...
            <button 
              ...
              className="btn-cyber-secondary py-1.5 px-2 sm:px-3 text-xs flex items-center gap-1.5 font-mono rounded-lg border border-slate-300 dark:border-slate-700 bg-white/90 dark:bg-slate-900/80 text-slate-800 dark:text-slate-200 shadow-sm"
              title={connected && publicKey ? publicKey.toBase58() : "Kết nối ví Solana"}
            >
              <span className={`w-1.5 h-1.5 rounded-full ${connected ? 'bg-emerald-500 cyber-pulsing-dot' : 'bg-slate-400'}`}></span>
